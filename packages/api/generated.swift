...
class AppRouter {
    ...
    lazy var auth = AuthRouter(url: url.appendingPathComponent("auth"), middlewares: middlewares, responseMiddlewares: responseMiddlewares)
    ...
    class AuthRouter {
        ...
        struct LoginInput: Codable, Equatable, Hashable {
            var email: String
            var password: String
        ...
        func login(input: LoginInput) async throws -> Void {
            let _: TRPCClient.EmptyObject = try await TRPCClient.sendMutation(url: url.appendingPathExtension("login"), middlewares: middlewares, responseMiddlewares: responseMiddlewares, input: input)
        }
        ...
        func logout() async throws -> Void {
            let _: TRPCClient.EmptyObject = try await TRPCClient.sendMutation(url: url.appendingPathExtension("logout"), middlewares: middlewares, responseMiddlewares: responseMiddlewares, input: TRPCClient.EmptyObject())
        }
        
        func getSession() async throws -> Void {
    ...
    class PermissionRouter {
        ...
        func assignRole(input: AssignRoleInput) async throws -> Void {
            let _: TRPCClient.EmptyObject = try await TRPCClient.sendMutation(url: url.appendingPathExtension("assignRole"), middlewares: middlewares, responseMiddlewares: responseMiddlewares, input: input)
        }
        
        struct RemoveRoleInput: Codable, Equatable, Hashable {
            var userId: String
            var roleId: String
        ...
        func removeRole(input: RemoveRoleInput) async throws -> Void {
            let _: TRPCClient.EmptyObject = try await TRPCClient.sendMutation(url: url.appendingPathExtension("removeRole"), middlewares: middlewares, responseMiddlewares: responseMiddlewares, input: input)
        }
        
        struct GrantPermissionInput: Codable, Equatable, Hashable {
            var userId: String
            var permissionId: String
            
            init(userId: String, permissionId: String) {
                self.userId = userId
                self.permissionId = permissionId
            }
        }
        
        func grantPermission(input: GrantPermissionInput) async throws -> Void {
            let _: TRPCClient.EmptyObject = try await TRPCClient.sendMutation(url: url.appendingPathExtension("grantPermission"), middlewares: middlewares, responseMiddlewares: responseMiddlewares, input: input)
        }
        
        struct RevokePermissionInput: Codable, Equatable, Hashable {
            var userId: String
            var permissionId: String
        ...
        func revokePermission(input: RevokePermissionInput) async throws -> Void {
            let _: TRPCClient.EmptyObject = try await TRPCClient.sendMutation(url: url.appendingPathExtension("revokePermission"), middlewares: middlewares, responseMiddlewares: responseMiddlewares, input: input)
        }
