...
import type { kioskRouter } from '#routes/kiosk/_router';
import type { navigatorRouter } from '#routes/navigator/_router';
...
export type KioskRouter = typeof kioskRouter;
export type NavigatorRouter = typeof navigatorRouter;
