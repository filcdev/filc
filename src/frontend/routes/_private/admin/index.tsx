...
import { DoorOpenChart } from '~/frontend/components/doorlock/door-open-chart';
import {
  Alert,
  AlertDescription,
  AlertTitle,
...
type StatsResponse = InferResponseType<
  typeof apiClient.doorlock.stats.overview.$get
>;
...
function DoorlockDashboard() {
  const statsQuery = useQuery({
    queryFn: async (): Promise<DoorlockStatsOverview> => {
      const res = await parseResponse(apiClient.doorlock.stats.overview.$get());
